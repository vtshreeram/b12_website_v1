    ...
    <section id="who-we-serve" className="py-24 px-6 md:px-10 lg:px-20 bg-[#fbfbfc] border-t border-gray-100">
      <div className="max-w-6xl mx-auto">
        <div className="mb-16 fade-in-up">
          <h2 className="text-3xl font-medium tracking-tight text-gray-900">Who We Serve</h2>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-12">
          {specialties.map((specialty) => (
            <div key={specialty.category} className={`fade-in-up ${specialty.delay}`}>
              <h4 className="text-lg font-semibold text-gray-900 mb-4 border-b border-gray-200 pb-2">{specialty.category}</h4>
